...
// const SupabaseComments = ({post}:Props) => {
...
//           if (comment._id === editData.commentId) {
...
//       mutate(
//         "api/comments",
//         commentList.filter((comment) => comment._id !== id),
//         false
//       );
...
//                     Reply of:{" "}
//                     {commentList?.find((comment) => comment._id === replyOf)
//                       ?.payload ?? ""}
//                   </p>
//                   <button
...
//                     {comment.name}
//                     {comment._updatedAt !== comment.publishedAt && (
...
//                           <button
//                             type="button"
//                             onClick={() => setReplyOf(comment._id)}
